...
class Injector {
    ...
    async resolveComponentInstance(module, name, dependencyContext, wrapper) {
        const components = module.components;
        const instanceWrapper = await this.lookupComponent(components, module, Object.assign({}, dependencyContext, { name }), wrapper);
    ...
    async lookupComponent(components, module, dependencyContext, wrapper) {
        ...
        const scanInExports = () => this.lookupComponentInExports(dependencyContext, module, wrapper);
    ...
    async instantiateClass(instances, wrapper, targetMetatype) {
        ...
        if (shared_utils_1.isNil(inject)) {
            targetMetatype.instance = Object.assign(targetMetatype.instance, new metatype(...instances));
        }
        else {
